    ...
    return (
        <div className="min-h-screen flex flex-col bg-slate-bg font-sans selection:bg-teal selection:text-white">
            ...
            <main className="flex-1 flex items-center justify-center p-4 py-24 sm:py-32 relative overflow-hidden">
                ...
                <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[600px] h-[600px] bg-teal/5 rounded-full blur-[100px] pointer-events-none" />
                <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-sky/5 rounded-full blur-[80px] pointer-events-none" />
                ...
                <div className="w-full max-w-[420px] relative z-10">
                    <div className="text-center mb-8">
                        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white shadow-xl shadow-teal/5 border border-slate-text/10 mb-6 relative">
                            <ShieldCheck className="w-8 h-8 text-teal relative z-10" />
                        ...
                        <p className="text-slate-muted">{t("authority.subheading")}</p>
                    </div>
                        ...
                        <div className="p-8">
                            <form onSubmit={handleLogin} className="space-y-5">
                                <div className="space-y-1.5">
                                    <Label className="text-slate-text font-medium text-sm">{t("authority.officer_id")}</Label>
                                    <Input
                                        required
                                        value={officerId}
                                ...
                                <div className="space-y-1.5">
                                    <Label className="text-slate-text font-medium text-sm">{t("authority.password")}</Label>
                                    <Input
                                        required
                                        type="password"
                                        value={password}
